      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          <motion.div
            ...
            className="fixed inset-0 w-full h-full bg-[#050816] z-[999] flex flex-col items-center justify-center font-heading"
          >
            {/* Ambient background blob */}
            <div className="absolute w-[30vw] h-[30vw] rounded-full bg-cyan-500/10 blur-[100px] pointer-events-none" />
            ...
            <div className="flex flex-col items-center gap-4 relative z-10">
              ...
              <motion.div
                ...
                className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center font-black text-white text-xl shadow-[0_0_30px_rgba(6,182,212,0.4)]"
              >
                AD
              </motion.div>

              <h1 className="text-xs uppercase tracking-[0.25em] font-extrabold text-slate-400 mt-2">
              ...
              {/* Progress bar track */}
              <div className="w-48 h-[3px] bg-slate-950 rounded-full overflow-hidden border border-white/5 mt-2">
                <div
