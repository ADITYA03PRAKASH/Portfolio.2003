...
function StatCounter({ target, label, suffix }: StatItem) {
  ...
  return (
    <div ref={ref} className="flex flex-col items-center p-6 rounded-3xl glass-card border border-black/5 relative group overflow-hidden bg-white/70">
...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-24 w-full bg-[#FFF8F2] border-y border-[#F2D6C2] overflow-hidden">
          ...
          <div className="md:col-span-6 lg:col-span-3 flex justify-center">
            <div className="w-full max-w-[260px] rounded-3xl border border-black/5 glass-card p-2 relative overflow-hidden group shadow-2xl bg-white/70">
              ...
              <img
                ...
                className="w-full aspect-[4/5] object-cover rounded-3xl group-hover:scale-[1.03] transition-transform duration-500"
              />
            ...
            <div className="relative border-l border-black/10 pl-6 space-y-8 py-1">
              {journey.map((item, idx) => (
                ...
                >
                  ...
                  <div className="p-5 rounded-3xl glass-card border border-black/5 hover:border-primary/20 hover:shadow-xl hover:shadow-orange-500/5 transition-colors bg-white/70">
